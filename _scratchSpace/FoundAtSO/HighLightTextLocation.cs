...
namespace kuujinbo.StackOverflow.iTextSharp._scratchSpace.FoundAtSO
{
    public class HighLightTextLocation : ITextExtractionStrategy
    {
        ...
        public List<Rectangle> GetTextLocations(string pSearchString, System.StringComparison pStrComp)
        {
            List<Rectangle> FoundMatches = new List<Rectangle>();
            StringBuilder sb = new StringBuilder();
        ...
        private Rectangle GetRectangleFromText(TextChunk FirstChunk, TextChunk LastChunk, string pSearchString, string sTextinChunks, int iFromChar, int iToChar, System.StringComparison pStrComp)
        {
